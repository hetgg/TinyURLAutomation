...
resource "aws_instance" "week14-vm" {
...
/*
resource "aws_instance" "week14-worker-vm" {
  ...
  tags = {
    Name = "week14-worker-vm"
  }
iam_instance_profile = aws_iam_instance_profile.week14-profile.name
}


resource "aws_iam_instance_profile" "week14-profile" {
  name = "week14-profile"
